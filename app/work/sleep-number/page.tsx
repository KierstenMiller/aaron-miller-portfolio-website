...
export default function SleepNumber() {
    ...
    return (<div>
        ...
        />
        <Image src="/images/sleep-number/SN_desktop_01.jpg" width={fullWidth} height={1025} alt="digital rendering of a sleep number bed" />
        <HeadBlurb
        ...
        <ImageContainer
            images={[
                {id:'desktop-2', src: '/images/sleep-number/SN_desktop_02.png', width: fullWidth, height: 600, alt: ''},
            ]}
        />
        <ImageContainer
            images={[
                {id:'desktop-3', src: '/images/sleep-number/SN_desktop_03.png', width: fullWidth, height: 600, alt: ''},
            ]}
        />
        <ImageContainer 
            images={[
                {id:'desktop-4', src: '/images/sleep-number/SN_desktop_04.png', width: fullWidth, height: 310, alt: ''},
                {id:'desktop-5', src: '/images/sleep-number/SN_desktop_05.png', width: fullWidth, height: 310, alt: ''}
            ]}
        />
        <HeadBlurb
        ...
        <ImageContainer 
            images={[
                {id:'desktop-6', src: '/images/sleep-number/SN_desktop_06.png', width: fullWidth, height: 600, alt: ''},
            ]}
        />
        <ImageContainer 
            images={[
                {id:'desktop-7', src: '/images/sleep-number/SN_desktop_07.png', width: fullWidth, height: 600, alt: ''},
            ]}
        />
        ...
        <ImageContainer 
            images={[
                {id:'desktop-8', src: '/images/sleep-number/SN_desktop_08.png', width: fullWidth, height: 1205, alt: ''},
                {id:'desktop-9', src: '/images/sleep-number/SN_desktop_09.png', width: fullWidth, height: 930, alt: ''},
            ]}
        />
        <ImageContainer 
            images={[
                {id:'desktop-7', src: '/images/sleep-number/SN_desktop_10.png', width: fullWidth, height: 600, alt: ''},
            ]}
        />
