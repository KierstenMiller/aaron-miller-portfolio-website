                ...
                <div className={styles['x-home-container']}>
                    <a className={styles['x-home-button']} href="/">
                        ...
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M10.5884 11.1758L28.5296 29.117" stroke="#636363" strokeWidth="0.75" strokeLinejoin="round" />
                            <path d="M28.824 11.1758L10.8828 29.117" stroke="#636363" strokeWidth="0.75" strokeLinejoin="round" />
                        </svg>
                    </a>
                </div>
