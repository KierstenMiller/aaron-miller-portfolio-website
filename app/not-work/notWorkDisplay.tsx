...
export const NotWorkDisplay = () => {
    const sharedImages = {
        arcana: {
            icon1Mobile: { id: 'arcana-icon-1-mobile', src: '/static/images/not-work/arcana-icon-1-mobile.png', alt: 'Arcana Icon 1' },
            icon2Mobile: { id: 'arcana-icon-2-mobile', src: '/static/images/not-work/arcana-icon-2-mobile.png', alt: 'Arcana Icon 2' },
            icon3Mobile: { id: 'arcana-icon-3-mobile', src: '/static/images/not-work/arcana-icon-3-mobile.png', alt: 'Arcana Icon 3' },
            imageDetailMobile: { id: 'arcana-image-detail-mobile', src: '/static/images/not-work/arcana-image-detail-mobile.png', alt: 'Arcana Image Detail' },
            posterDesktop: { id: 'arcana-poster-desktop', src: '/static/images/not-work/arcana-poster-desktop.png', alt: 'Arcana Poster' },
            posterMobile: { id: 'arcana-poster-mobile', src: '/static/images/not-work/arcana-poster-mobile.png', alt: 'Arcana Poster' },
            ticketDesktop: { id: 'arcana-ticket-desktop', src: '/static/images/not-work/arcana-ticket-desktop.png', alt: 'Arcana Ticket' },
            ticketMobile: { id: 'arcana-ticket-mobile', src: '/static/images/not-work/arcana-ticket-mobile.png', alt: 'Arcana Ticket' },
        ...
        feast: {
            ...
            imageDetailDesktop: { id: 'feast-image-detail-desktop', src: '/static/images/not-work/feast-image-detail-desktop.png', alt: 'Feast Image Detail' },
            imageDetailMobile: { id: 'feast-image-detail-mobile', src: '/static/images/not-work/feast-image-detail-mobile.png', alt: 'Feast Image Detail' },
            posterDesktop: { id: 'feast-poster-desktop', src: '/static/images/not-work/feast-poster-desktop.png', alt: 'Feast Poster' },
            posterMobile: { id: 'feast-poster-mobile', src: '/static/images/not-work/feast-poster-mobile.png', alt: 'Feast Poster' },
            type: { id: 'feast-type', src: '/static/images/not-work/feast-type.png', alt: 'Feast Type' },
        },
        forestDweller: {
            imageDetailMobile: { id: 'forest-dweller-image-detail-mobile', src: '/static/images/not-work/forest-dweller-image-detail-mobile.png', alt: 'Forest Dweller Image Detail' },
            ...
            mobile: { id: 'forest-dweller-mobile', src: '/static/images/not-work/forest-dweller-mobile.png', alt: 'Forest Dweller' },
            poster: { id: 'forest-dweller-poster', src: '/static/images/not-work/forest-dweller-poster.png', alt: 'Forest Dweller Poster' },
            shirtMobile: { id: 'forest-dweller-shirt-mobile', src: '/static/images/not-work/forest-dweller-shirt-mobile.png', alt: 'Forest Dweller Shirt' },
            shirt: { id: 'forest-dweller-shirt', src: '/static/images/not-work/forest-dweller-shirt.png', alt: 'Forest Dweller Shirt' },
            type1Desktop: { id: 'forest-dweller-type-1-desktop', src: '/static/images/not-work/forest-dweller-type-1-desktop.png', alt: 'Forest Dweller Type 1' },
            type2Desktop: { id: 'forest-dweller-type-2-desktop', src: '/static/images/not-work/forest-dweller-type-2-desktop.png', alt: 'Forest Dweller Type 2' },
            type3Desktop: { id: 'forest-dweller-type-3-desktop', src: '/static/images/not-work/forest-dweller-type-3-desktop.png', alt: 'Forest Dweller Type 3' },
            typeMobile: { id: 'forest-dweller-type-mobile', src: '/static/images/not-work/forest-dweller-type-mobile.png', alt: 'Forest Dweller Type' },
        },
        tasty: {
            ...
            imageDetailDesktop: { id: 'tasty-image-detail-desktop', src: '/static/images/not-work/tasty-image-detail-desktop.png', alt: 'Tasty Image Detail' },
            imageDetailMobile: { id: 'tasty-image-detail-mobile', src: '/static/images/not-work/tasty-image-detail-mobile.png', alt: 'Tasty Image Detail' },
            posterDesktop: { id: 'tasty-poster-desktop', src: '/static/images/not-work/tasty-poster-desktop.png', alt: 'Tasty Poster' },
            posterMobile: { id: 'tasty-poster-mobile', src: '/static/images/not-work/tasty-poster-mobile.png', alt: 'Tasty Poster' },
    ...
    return <div>
        <div id="mobile" className={classNames('mobile-max-down-only', styles['top-stack'])}>
            ...
            <div id="tasty" className={styles['stack']}>
                <div className={styles['mobile-one-row']}>
                    <Image {...sharedImages.tasty.imageDetailMobile} width={350} height={350} />
                </div>
                <div className={styles['mobile-one-row']}>
